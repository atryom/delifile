...
| `docs/endpoints.md` | Полный список API-эндпоинтов (~173 шт.) | ✅ |
| `docs/permission.md` | Матрица прав доступа, сценарии A–M | ✅ |
| `docs/tests.md` | Сводный отчёт по тестированию (~1018 тестов) | ✅ |
...
| 6.19 | **Уведомления** | 17 | 8 | **25** |
| 6.20 | **Папки (Shared Folder — unified)** | — | 42 | **42** |
| | **Итого** | **~509** | **~473** | **~1018** |
...
См. `docs/endpoints.md` — ~173 REST API endpoint'ов, разделённых на 34 логические группы.
...
| M | Приватность в папке (is_private) | Owner скрывает подпапку/файл от гостей; гости не видят приватные объекты |
